// Slider
let taskLeftArrow = document.querySelector('.controls-left'),
...
var slider1 = slider(
    'tasks-slider',
    '.tasks__slider-item',
    taskLeftArrow, taskRightArrow, false);
...
// Slider number 2
let prizesLeftArrow = document.querySelector('.controls-left-2'),
    prizesRightArrow = document.querySelector('.controls-right-2');


var slider2 = sliderTwo(
    'prize-slider',
    '.prize__slider-item',
